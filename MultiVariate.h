...
// Mon Jun 17 13:43:14 2019 by ROOT version 6.16/00
// from TTree DecayTree/DecayTree
// found on file: combined.root
//////////////////////////////////////////////////////////
...
class MultiVariate : public TSelector {
public :
   ...
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Global_Dec = {fReader, "Xi_c0_Hlt2Global_Dec"};
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Global_TIS = {fReader, "Xi_c0_Hlt2Global_TIS"};
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Global_TOS = {fReader, "Xi_c0_Hlt2Global_TOS"};
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Phys_Dec = {fReader, "Xi_c0_Hlt2Phys_Dec"};
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Phys_TIS = {fReader, "Xi_c0_Hlt2Phys_TIS"};
   TTreeReaderValue<Bool_t> Xi_c0_Hlt2Phys_TOS = {fReader, "Xi_c0_Hlt2Phys_TOS"};
   ...
   TTreeReaderValue<Bool_t> Omega_Hlt2Global_Dec = {fReader, "Omega_Hlt2Global_Dec"};
   TTreeReaderValue<Bool_t> Omega_Hlt2Global_TIS = {fReader, "Omega_Hlt2Global_TIS"};
   TTreeReaderValue<Bool_t> Omega_Hlt2Global_TOS = {fReader, "Omega_Hlt2Global_TOS"};
   TTreeReaderValue<Bool_t> Omega_Hlt2Phys_Dec = {fReader, "Omega_Hlt2Phys_Dec"};
   TTreeReaderValue<Bool_t> Omega_Hlt2Phys_TIS = {fReader, "Omega_Hlt2Phys_TIS"};
   TTreeReaderValue<Bool_t> Omega_Hlt2Phys_TOS = {fReader, "Omega_Hlt2Phys_TOS"};
   ...
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Global_Dec = {fReader, "OmegaK_Hlt2Global_Dec"};
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Global_TIS = {fReader, "OmegaK_Hlt2Global_TIS"};
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Global_TOS = {fReader, "OmegaK_Hlt2Global_TOS"};
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Phys_Dec = {fReader, "OmegaK_Hlt2Phys_Dec"};
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Phys_TIS = {fReader, "OmegaK_Hlt2Phys_TIS"};
   TTreeReaderValue<Bool_t> OmegaK_Hlt2Phys_TOS = {fReader, "OmegaK_Hlt2Phys_TOS"};
   ...
   ClassDef(MultiVariate,0);

};

#endif

#ifdef MultiVariate_cxx
void MultiVariate::Init(TTree *tree)
{
