...
// Tue Jun 18 14:08:49 2019 by ROOT version 6.16/00
// from TTree DecayTree/DecayTree
// found on file: myOmegamKpTuple_2017
//////////////////////////////////////////////////////////
...
class Xi_c0_2017 : public TSelector {
public :
   TTreeReader     fReader;  //!the tree reader
   TTree          *fChain = 0;   //!pointer to the analyzed TTree or TChain

   // Readers to access the data (delete the ones you do not need).
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_X = {fReader, "Xic0_ENDVERTEX_X"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_Y = {fReader, "Xic0_ENDVERTEX_Y"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_Z = {fReader, "Xic0_ENDVERTEX_Z"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_XERR = {fReader, "Xic0_ENDVERTEX_XERR"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_YERR = {fReader, "Xic0_ENDVERTEX_YERR"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_ZERR = {fReader, "Xic0_ENDVERTEX_ZERR"};
   TTreeReaderValue<Double_t> Xic0_ENDVERTEX_CHI2 = {fReader, "Xic0_ENDVERTEX_CHI2"};
   TTreeReaderValue<Int_t> Xic0_ENDVERTEX_NDOF = {fReader, "Xic0_ENDVERTEX_NDOF"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_X = {fReader, "Xic0_OWNPV_X"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_Y = {fReader, "Xic0_OWNPV_Y"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_Z = {fReader, "Xic0_OWNPV_Z"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_XERR = {fReader, "Xic0_OWNPV_XERR"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_YERR = {fReader, "Xic0_OWNPV_YERR"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_ZERR = {fReader, "Xic0_OWNPV_ZERR"};
   TTreeReaderValue<Double_t> Xic0_OWNPV_CHI2 = {fReader, "Xic0_OWNPV_CHI2"};
   TTreeReaderValue<Int_t> Xic0_OWNPV_NDOF = {fReader, "Xic0_OWNPV_NDOF"};
   TTreeReaderValue<Double_t> Xic0_IP_OWNPV = {fReader, "Xic0_IP_OWNPV"};
   TTreeReaderValue<Double_t> Xic0_IPCHI2_OWNPV = {fReader, "Xic0_IPCHI2_OWNPV"};
   TTreeReaderValue<Double_t> Xic0_FD_OWNPV = {fReader, "Xic0_FD_OWNPV"};
   TTreeReaderValue<Double_t> Xic0_FDCHI2_OWNPV = {fReader, "Xic0_FDCHI2_OWNPV"};
   TTreeReaderValue<Double_t> Xic0_DIRA_OWNPV = {fReader, "Xic0_DIRA_OWNPV"};
   TTreeReaderValue<Double_t> Xic0_P = {fReader, "Xic0_P"};
   TTreeReaderValue<Double_t> Xic0_PT = {fReader, "Xic0_PT"};
   TTreeReaderValue<Double_t> Xic0_PE = {fReader, "Xic0_PE"};
   TTreeReaderValue<Double_t> Xic0_PX = {fReader, "Xic0_PX"};
   TTreeReaderValue<Double_t> Xic0_PY = {fReader, "Xic0_PY"};
   TTreeReaderValue<Double_t> Xic0_PZ = {fReader, "Xic0_PZ"};
   TTreeReaderValue<Double_t> Xic0_MM = {fReader, "Xic0_MM"};
   TTreeReaderValue<Double_t> Xic0_MMERR = {fReader, "Xic0_MMERR"};
   TTreeReaderValue<Double_t> Xic0_M = {fReader, "Xic0_M"};
   TTreeReaderValue<Int_t> Xic0_ID = {fReader, "Xic0_ID"};
   TTreeReaderValue<Double_t> Xic0_TAU = {fReader, "Xic0_TAU"};
   TTreeReaderValue<Double_t> Xic0_TAUERR = {fReader, "Xic0_TAUERR"};
   TTreeReaderValue<Double_t> Xic0_TAUCHI2 = {fReader, "Xic0_TAUCHI2"};
   TTreeReaderValue<Bool_t> Xic0_L0Global_Dec = {fReader, "Xic0_L0Global_Dec"};
   TTreeReaderValue<Bool_t> Xic0_L0Global_TIS = {fReader, "Xic0_L0Global_TIS"};
   TTreeReaderValue<Bool_t> Xic0_L0Global_TOS = {fReader, "Xic0_L0Global_TOS"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Global_Dec = {fReader, "Xic0_Hlt1Global_Dec"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Global_TIS = {fReader, "Xic0_Hlt1Global_TIS"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Global_TOS = {fReader, "Xic0_Hlt1Global_TOS"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Phys_Dec = {fReader, "Xic0_Hlt1Phys_Dec"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Phys_TIS = {fReader, "Xic0_Hlt1Phys_TIS"};
   TTreeReaderValue<Bool_t> Xic0_Hlt1Phys_TOS = {fReader, "Xic0_Hlt1Phys_TOS"};
   TTreeReaderValue<Double_t> Xic0_X = {fReader, "Xic0_X"};
   TTreeReaderValue<Double_t> Xic0_Y = {fReader, "Xic0_Y"};
   ...
   ClassDef(Xi_c0_2017,0);

};

#endif

#ifdef Xi_c0_2017_cxx
void Xi_c0_2017::Init(TTree *tree)
{
