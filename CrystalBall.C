...
// par[4] = fraction in Gaussian
	// the user should constrain par[4] to lie in the range (0.55 - 0.999999)
// par[5] = intercept of linear background
// par[6] = slope of linear background
// par[7] = Crystal Ball "alpha" (function uses absolute valu
...
// Create a Double Gaussian with a Width Sigma1 & Sigma2 and Common Mean Mu
